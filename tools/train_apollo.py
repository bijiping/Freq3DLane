import sys
sys.path.append('/home/user2023/bijiping/3D/bev_lane_det-main')# 添加模块搜索路径
import torch
...
if __name__ == '__main__':
    ...
    worker_function('/home/user2023/bijiping/3D/bev_lane_det-main/tools/apollo_config.py', gpu_id=[1])  # 调用worker_function函数，传入配置文件路径和GPU编号
