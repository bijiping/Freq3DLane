...
model_path = '/home/user2023/bijiping/3D/bev_lane_det-main/dataset/model/apollo/1210/latest.pth' #model path of verification

''' parameter from config '''
config_file = './apollo_config_test.py'
