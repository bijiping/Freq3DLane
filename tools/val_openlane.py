...
import time
import sys
sys.path.append('/home/user2023/bijiping/3D/bev_lane_det-main')
import os
gpu_id = [0]
...
model_path = '/home/user2023/bijiping/3D/bev_lane_det-main/dataset/model/openlane/1225/ep020.pth' #model path of verification

''' parameter from config '''
config_file = './openlane_config_test.py'
...
tmp_save_path = './workspace/tmp_openlane/test' #tmp path for save intermediate result
...
def val():
    ...
    total_time = 0  # Total time for processing all batches
